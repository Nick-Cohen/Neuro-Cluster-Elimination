...
# Base configuration (matching lines 174-184 of original)
gm_config = {
    'device': device,
    'hidden_sizes': [3, 3],
    'optimizer': 'adam',
    'num_epochs': 100000,  # Use full epochs with early stopping
    'traced_losses': [],
    'val_set': 'all',
    'lr': 1e-3,
    'lr_decay': 1,
    ...
    'iB': 100,
    'ecl': 1e6,  # Use exact computation up to very large size (from line 184)
    'iB_backwards': 100,
    'plot_messages': False,
...
def main():
    ...
    test_indices = all_indices  # All benchmark problems
    ...
    config_ukl_elp['num_epochs'] = 100000
    config_ukl_elp['num_epochs2'] = 100000
    ...
    # Print summary
    print("\n" + "="*120)
    print("BENCHMARK TEST RESULTS - UKL vs UKL+ELP")
    print("="*120)
